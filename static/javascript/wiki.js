...
//
    var jsonstring = ' { "Menschen" : [' +
        ...
        ' { "Vorname" : "Lea", "Nachname" :"Soffel", "Gender": "female", "Rolle" : "Student"  },' +
    ...
    document.getElementById('PullupOptionsBtn').addEventListener("click", function () {
    ...
    document.getElementById('showwikibtn').addEventListener("click", function () {
    ...
    document.getElementById('content').addEventListener("click", function () {
        alert("DOOOONNN'T CLICK THE CONTENT!!!!");
    });
